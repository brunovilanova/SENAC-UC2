...
programa
{
	...
	/* adicionada a função TROCA, para trocar posição dos elementos dentro de um vetor
    */
	...
	/*criação da função AGUARDE, para melhorar a experiência do usuário
	*/
	funcao aguarde()
	{
	
			escreva("\n\n----------------------------------")
			escreva("\nOrganizando os números informados..")
			escreva("\n----------------------------------\n")
			utl.aguarde(1000)
	}
	...
	funcao inicio()
	{
		...
		/*montaVetor(vetor)
		        -- ative esta opção se não quiser informar os valores
	    */
 ...
 */
 ...
 /* esta última edição do algoritmo(01-03-2022) foi realizada via Portugol Studio Web
 */